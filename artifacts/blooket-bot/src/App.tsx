...
const CHEATS: Record<string, CheatDef[]> = {
  ...
  Gold: [
    ...
    { type: "button", name: "Freeze Scoreboard", action: async (b) => { const on = b.dataset.on !== "1"; b.dataset.on = on ? "1" : "0"; await setUserVal(on ? "tat/t" : "tat", "t"); b.textContent = on ? "Unfreeze Scoreboard" : "Freeze Scoreboard"; } },
    { type: "input", name: "Set Gold", action: (v) => setUserVal("g", v) },
  ...
  Candy: [
    { type: "button", name: "Crash Host", action: async (b) => { await setUserVal("g/t", "t"); b.textContent = "Crashing…"; } },
    { type: "button", name: "Freeze Scoreboard", action: async (b) => { const on = b.dataset.on !== "1"; b.dataset.on = on ? "1" : "0"; await setUserVal(on ? "tat/t" : "tat", "t"); b.textContent = on ? "Unfreeze Scoreboard" : "Freeze Scoreboard"; } },
    { type: "input", name: "Set Candy", action: (v) => setUserVal("g", v) },
  ...
  "Defense 2": [
    ...
    { type: "input", name: "Set Damage", action: (v) => setUserVal("d", v) },
    { type: "input", name: "Set Round", action: (v) => setUserVal("r", v) },
  ...
  Fish: [
    ...
    { type: "input", name: "Set Weight", action: (v) => setUserVal("w", v) },
  ...
  Pirate: [
    { type: "button", name: "Crash Host", action: async (b) => { await setUserVal("d/t", "t"); b.textContent = "Crashing…"; } },
    { type: "button", name: "Freeze Scoreboard", action: async (b) => { const on = b.dataset.on !== "1"; b.dataset.on = on ? "1" : "0"; await setUserVal(on ? "tat/t" : "tat", "t"); b.textContent = on ? "Unfreeze Scoreboard" : "Freeze Scoreboard"; } },
    { type: "input", name: "Set Doubloons", action: (v) => setUserVal("d", v) },
  ...
  Dino: [
    ...
    { type: "button", name: "Freeze Scoreboard", action: async (b) => { const on = b.dataset.on !== "1"; b.dataset.on = on ? "1" : "0"; await setUserVal(on ? "tat/t" : "tat", "t"); b.textContent = on ? "Unfreeze Scoreboard" : "Freeze Scoreboard"; } },
    { type: "input", name: "Set Fossils", action: (v) => setUserVal("f", v) },
  ...
  Cafe: [
    { type: "button", name: "Freeze Scoreboard", action: async (b) => { const on = b.dataset.on !== "1"; b.dataset.on = on ? "1" : "0"; await setUserVal(on ? "tat/t" : "tat", "t"); b.textContent = on ? "Unfreeze Scoreboard" : "Freeze Scoreboard"; } },
    { type: "input", name: "Set Cash", action: (v) => setUserVal("ca", v) },
  ...
  Brawl: [
    ...
    { type: "input", name: "Set XP", action: (v) => setUserVal("xp", v) },
  ...
  Racing: [
    ...
    { type: "input", name: "Set Questions Left", action: (v) => setUserVal("pr", v) },
  ...
  Rush: [
    ...
    { type: "input", name: "Set Blooks", action: (v) => setUserVal("bs", v) },
    { type: "input", name: "Set Defense", action: (v) => setUserVal("d", v) },
  ...
  Toy: [
    ...
    { type: "button", name: "Freeze Scoreboard", action: async (b) => { const on = b.dataset.on !== "1"; b.dataset.on = on ? "1" : "0"; await setUserVal(on ? "tat/t" : "tat", "t"); b.textContent = on ? "Unfreeze Scoreboard" : "Freeze Scoreboard"; } },
    { type: "input", name: "Set Toys", action: (v) => setUserVal("t", v) },
